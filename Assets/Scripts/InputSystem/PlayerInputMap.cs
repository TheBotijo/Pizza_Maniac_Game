...
//     version 1.4.4
//     from Assets/Scripts/InputSystem/PlayerInputMap.inputactions
//
...
public partial class @PlayerInputMap : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""MousePos"",
                    ""type"": ""Value"",
                    ""id"": ""2457efa6-1cd9-4b5f-aa74-cd5c8907884a"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""6dd6e191-ca4f-4c2a-8a2a-422bf5d5e952"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_Juego_MousePos = m_Juego.FindAction("MousePos", throwIfNotFound: true);
        // UI
    ...
    private readonly InputAction m_Juego_MousePos;
    public struct JuegoActions
    {
        ...
        public InputAction @MousePos => m_Wrapper.m_Juego_MousePos;
        ...
        public void SetCallbacks(IJuegoActions instance)
        {
            if (m_Wrapper.m_JuegoActionsCallbackInterface != null)
            {
                ...
                @MousePos.started -= m_Wrapper.m_JuegoActionsCallbackInterface.OnMousePos;
                @MousePos.performed -= m_Wrapper.m_JuegoActionsCallbackInterface.OnMousePos;
                @MousePos.canceled -= m_Wrapper.m_JuegoActionsCallbackInterface.OnMousePos;
            }
